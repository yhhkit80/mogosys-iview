...
<template>
	<div class="main" :class="{'main-hide-text': shrink}">
		<div class="side-toggle-btn" :style="{left: shrink?'60px':'200px'}" @click="toggleClick"><span class="togcon"><Icon type="navicon" size="16" :style="{transform: 'rotateZ(' + (this.shrink ? '-90' : '0') + 'deg)'}"></Icon></span></div>
